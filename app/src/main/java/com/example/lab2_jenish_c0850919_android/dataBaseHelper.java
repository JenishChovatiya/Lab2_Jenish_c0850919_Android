...
public class dataBaseHelper extends SQLiteOpenHelper
{
    ...
    public RawData getProduct(int id){
        ...
        Cursor cursor=db.query(TABLE_NAME,new String[]{UniqueID, product_id, product_name, product_description, product_price},UniqueID+" = ?",new String[]{String.valueOf(id)},null,null,null);
        if(cursor!=null){
            cursor.moveToFirst();
        }
   ...
   public List<RawData> getAll(){
    ...
    public int updateProduct(RawData productModel)
    {
        ...
        return db.update(TABLE_NAME,contentValues,product_id+"=?",new String[]{String.valueOf(productModel.getproduct_id())});
